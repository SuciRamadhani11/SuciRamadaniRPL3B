 ...
 * Kelas ini memiliki atribut nim, nama, dan jurusan yang bersifat private
 * Konstruktor digunakan untuk menginisiasi objek Mahasiswa dengan nilai yang diberikan
 * Getter (getNim(), getNama(), dan getJurusan()) digunakan untuk mengakses nilai atribut
 * Metode toString() digunakan untuk mengembalikan informasi mahasiswa dalam bentuk String
 */
class Mahasiswa {
 ...
 * Melakukan pencarian linear (sequential search) pada ArrayList berdasarkan NIM
 * Mengembalikan indeks mahasiswa jika ditemukan, atau -1 jika tidak ditemukan.
 */
